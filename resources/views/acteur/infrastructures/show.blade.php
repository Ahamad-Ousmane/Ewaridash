...
@section('title', $infrastructure->nom . ' - TourismoRA')
        ...
        <div class="relative">
            ...
            <div x-data="{ currentImage: 0, images: {{ json_encode($infrastructure->images) }} }" class="relative">
                <div class="aspect-w-16 aspect-h-6 bg-gray-200">
                    <img :src="`/storage/${images[currentImage]}`" 
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div class="relative group cursor-pointer" onclick="openImageModal('{{ $image }}', {{ $index }})">
...
function navigateImage(direction) {
    ...
    document.getElementById('modalImage').src = '/storage/' + images[currentImageIndex];
}
